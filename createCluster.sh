...
docker run --detach --interactive --init --tty --rm --net rabbits --hostname rabbit-1 --name rabbit-1 --publish 8081:15672 #-v /workspaces/RabbitMqDemo/target/debian:/RabbitMqDemoMount debian-RabbitMqDemo-runner
docker run --detach --interactive --init --tty --rm --net rabbits --hostname rabbit-2 --name rabbit-2 --publish 8082:15672 #-v /workspaces/RabbitMqDemo/target/debian:/RabbitMqDemoMount debian-RabbitMqDemo-runner
docker run --detach --interactive --init --tty --rm --net rabbits --hostname rabbit-3 --name rabbit-3 --publish 8083:15672 #-v /workspaces/RabbitMqDemo/target/debian:/RabbitMqDemoMount debian-RabbitMqDemo-runner
